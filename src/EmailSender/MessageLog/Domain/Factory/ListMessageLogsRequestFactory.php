...
/**
 * Class ListMessageLogsRequestFactory
 *
...
class ListMessageLogsRequestFactory
{
    ...
    /**
     * ListMessageLogsRequestFactory constructor.
     *
     ...
     */
    public function create(array $listMessageLogsRequestArray): ListMessageLogsRequest
    {
     ...
     * @throws \InvalidArgumentException
     */
    private function getFromFromRequest(array $listMessageLogsRequestArray): ?EmailAddress
    {
        $from = null;
